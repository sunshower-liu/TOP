...
def main():
    ...
    output_dir = args.output_dir.format(model_name="top_causal_"+args.model_name.replace("/", "_"))
    output_dir2 = args.output_dir.format(model_name="top_causal_"+args.model_name.replace("/", "_") + "_edited")
    ...
    for knowledge in tqdm(knowns):
        ...
        mt2 = ModelAndTokenizer(f"gptj-top-{known_id}", torch_dtype=torch_dtype)
